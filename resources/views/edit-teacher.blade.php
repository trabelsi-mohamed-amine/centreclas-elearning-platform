...
<div class="container mt-5">
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h2 class="mb-0">Modifier Formateur</h2>
        </div>
        <div class="card-body">
            @if ($errors->any())
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="cin" name="cin" class="form-control" value="{{ old('cin', $teacher->cin) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="telephone" name="telephone" class="form-control" value="{{ old('telephone', $teacher->telephone) }}"
                                required minlength="8" maxlength="8" data-numeric-only="true">
                            <div class="invalid-feedback">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" id="date_of_birth" name="date_of_birth" class="form-control"
                            value="{{ old('date_of_birth', $teacher->date_of_birth) }}" required max="{{ date('Y-m-d') }}">
                        <div class="invalid-feedback">
