        ...
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title mb-0">Ajouter une Session</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('sessions.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                        @csrf
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('formation_id') is-invalid @enderror"
                                    ...
                                    <option value="" disabled selected>Ajouter formation</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('teacher_id') is-invalid @enderror"
                                    ...
                                    <option value="" disabled selected>Selectionner formateur</option>
